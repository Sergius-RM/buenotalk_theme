...
class WPVQGR_Quiz {
	...
	public function getPublicSettings() 
	{
		...
		$hiddenSettings = array('syncuser_mailchimp_apikey', 'syncuser_mailchimp_listid', 'syncuser_aweber_apikey', 'syncuser_aweber_listid', 'syncuser_activecampaign_urlendpoint', 'syncuser_activecampaign_apikey', 'syncuser_activecampaign_listid', 'syncuser_activecampaign_tags');
	...
	public function load($id) 
	{
		...
		(
			...
			'askinfo_localsave' 	=>  $this->get('settings_askinfo_localsave'),
