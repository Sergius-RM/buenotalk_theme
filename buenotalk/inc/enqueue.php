...
function theme_styles()
{
    ...
    wp_register_style('bootstrap-icons', get_template_directory_uri() . '/assets/css/bootstrap-icons.css', '', '1.11.1', 'all');
...
function theme_script() {
    ...
    wp_enqueue_script('jquery_script', get_template_directory_uri() . '/assets/js/jquery-3.6.0.min.js', array(), '', false);
